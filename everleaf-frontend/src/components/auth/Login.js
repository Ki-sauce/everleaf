          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="mt-6">
              ...
              <button
                ...
                className="mt-3 w-full py-3 flex items-center justify-center bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors"
              >
